...
public class CangSangZhengDaoEntity extends Entity {
    private EntityPlayer player;
    public CangSangZhengDaoEntity(World worldIn) {
        super(worldIn);
    }
    public CangSangZhengDaoEntity(World worldIn, EntityPlayer player) {
        super(worldIn);
        this.player = player;
    }
    @Override
