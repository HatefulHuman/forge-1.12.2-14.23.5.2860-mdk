...
public class SanZhuanZhenMoEntity extends Entity {
    private EntityPlayer player;
    public SanZhuanZhenMoEntity(World worldIn) {
        super(worldIn);
    }
    public SanZhuanZhenMoEntity(World worldIn, EntityPlayer player) {
        super(worldIn);
        this.player = player;
    }
    @Override
