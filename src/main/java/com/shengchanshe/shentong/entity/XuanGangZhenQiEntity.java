...
public class XuanGangZhenQiEntity extends Entity {
    private EntityPlayer player;
    public XuanGangZhenQiEntity(World worldIn) {
        super(worldIn);
    }
    public XuanGangZhenQiEntity(World worldIn, EntityPlayer player) {
        super(worldIn);
        this.player = player;
    }
    @Override
