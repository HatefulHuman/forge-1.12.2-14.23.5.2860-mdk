...
public class SanZhuanZhenMoModel extends ModelBase {
	...
	public SanZhuanZhenMoModel() {
		...
		Head_r4.cubeList.add(new ModelBox(Head_r4, 78, 150, -2.0F, -27.0F, -5.0F, 4, 14, 3, 0.0F, false));

		Head_r5 = new ModelRenderer(this);
		Head_r5.setRotationPoint(-0.25F, -4.0F, 0.0F);
		bone20.addChild(Head_r5);
		setRotationAngle(Head_r5, 0.0852F, 0.0189F, -0.2174F);
		Head_r5.cubeList.add(new ModelBox(Head_r5, 120, 158, -2.0F, -24.0F, -5.0F, 4, 8, 3, 0.0F, false));

		Head_r6 = new ModelRenderer(this);
		Head_r6.setRotationPoint(-0.25F, -4.0F, 0.0F);
		bone20.addChild(Head_r6);
		setRotationAngle(Head_r6, 0.0852F, -0.0189F, 0.2174F);
		Head_r6.cubeList.add(new ModelBox(Head_r6, 134, 158, -2.0F, -24.0F, -5.0F, 4, 8, 3, 0.0F, false));
		...
		Head_r7.cubeList.add(new ModelBox(Head_r7, 64, 150, -2.0F, -26.8911F, -3.7548F, 4, 14, 3, 0.0F, false));
		...
		Head_r8.cubeList.add(new ModelBox(Head_r8, 154, 0, -2.0236F, -23.8936F, -3.7548F, 4, 8, 3, 0.0F, false));
		...
		Head_r9.cubeList.add(new ModelBox(Head_r9, 157, 133, -1.9764F, -23.8936F, -3.7548F, 4, 8, 3, 0.0F, false));
		...
		Head_r10.cubeList.add(new ModelBox(Head_r10, 92, 150, -2.0F, -25.8911F, -3.7548F, 4, 13, 3, 0.0F, false));
		...
		Head_r11.cubeList.add(new ModelBox(Head_r11, 0, 0, -1.9764F, -23.8936F, -3.7548F, 4, 8, 3, 0.0F, false));
		...
		Head_r12.cubeList.add(new ModelBox(Head_r12, 106, 150, -2.0236F, -23.8936F, -3.7548F, 4, 8, 3, 0.0F, false));
		...
		setRotationAngle(Head_r15, 1.5708F, 1.0036F, 1.309F);
		Head_r15.cubeList.add(new ModelBox(Head_r15, 146, 95, -1.9473F, 5.217F, -3.0F, 7, 7, 4, 0.0F, false));
		...
		bone25.addChild(Head_r16);
		setRotationAngle(Head_r16, 1.5708F, -1.0036F, -1.309F);
		Head_r16.cubeList.add(new ModelBox(Head_r16, 21, 64, -5.0527F, 5.217F, -3.0F, 7, 7, 4, 0.0F, false));
		...
		Body_r1.cubeList.add(new ModelBox(Body_r1, 220, 30, -5.0F, -4.0F, -23.0F, 10, 6, 8, 0.0F, false));
