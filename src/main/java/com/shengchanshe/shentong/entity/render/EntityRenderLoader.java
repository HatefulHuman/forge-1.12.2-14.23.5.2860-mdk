...
public class EntityRenderLoader {
    public static void registerEntityRenderers() {
        ...
        RenderingRegistry.registerEntityRenderingHandler(YiZhuanZhenMoEntity.class,YiZhuanZhenMoRender::new);
        RenderingRegistry.registerEntityRenderingHandler(SanZhuanZhenMoEntity.class,SanZhuanZhenMoRender::new);
        RenderingRegistry.registerEntityRenderingHandler(LiuZhuanZhenMoEntity.class,LiuZhuanZhenMoRender::new);
