...
public class LiuZhuanZhenMo implements IMessage {
    private static long tick = 0;
    public LiuZhuanZhenMo() {

    }
    public LiuZhuanZhenMo(EntityPlayer player) {
    ...
    public static class Handler implements IMessageHandler<LiuZhuanZhenMo, IMessage> {

        @Override
        public IMessage onMessage(LiuZhuanZhenMo message, MessageContext ctx) {
            ctx.getServerHandler().player.getServerWorld().addScheduledTask(() -> {
                LiuJiZhenMoGong.LiuZhuanZhenMo(message,ctx);
            });
            return null;
        }
    }
