...
//真炎粒子效果
public class GuiMoDun implements IMessage {
    private double posX;
    private double posY;
    private double posZ;
    ...
    public GuiMoDun(double posX, double posY, double posZ) {
        this.posX = posX;
        this.posY = posY;
        this.posZ = posZ;
    }
    ...
    public static class Handler implements IMessageHandler<GuiMoDun, IMessage> {
        @Override
        public IMessage onMessage(GuiMoDun message, MessageContext ctx) {
